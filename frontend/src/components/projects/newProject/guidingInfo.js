		...
		<div className="container">
			<div className="row">
				<div className="col s12">
					...
					To get your project started, type in a project name and
					click initialize project. If this is your first project,
					don't worry! There will be plenty of explanation and
					recourses provided as you get started.
				</div>
			</div>
			<div className="row">
				{examples()}
